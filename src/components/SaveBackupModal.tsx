                ...
                <div className="space-y-4">
                  ...
                  <div className="border border-m3-outline-variant/50 rounded-2xl p-4 bg-m3-surface-container-low space-y-3">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      {/* Switch Toggle */}
                      <button
                        id="toggle-auto-sync-button"
                        type="button"
                        role="switch"
                        aria-checked={autoSyncOn}
                        onClick={handleToggleAutoSync}
                        className={`relative inline-flex h-7 w-12 shrink-0 cursor-pointer items-center rounded-full border transition-colors duration-200 ease-in-out focus:outline-hidden focus:ring-2 focus:ring-m3-primary/40 ${
                          autoSyncOn ? 'bg-m3-primary border-m3-primary' : 'bg-m3-surface-container-highest border-m3-outline-variant/40'
                        }`}
                      >
                        <span
                          aria-hidden="true"
