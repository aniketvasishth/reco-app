    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          name: 'Reco',
          short_name: 'Reco',
          description: 'Reco - Costco Wholesale Receipt Search and Instant On-Device Inventory Indexer.',
          theme_color: '#14060b',
          background_color: '#14060b',
          display: 'standalone',
          display_override: ['window-controls-overlay', 'standalone', 'minimal-ui'],
          orientation: 'portrait',
          start_url: '/?mode=standalone',
          scope: '/',
          categories: ['shopping', 'productivity', 'utilities', 'finance'],
          icons: [
            {
              src: '/icon-512.png',
              sizes: '512x512',
          ...
          shortcuts: [
            {
              name: 'Scan Receipt',
              short_name: 'Scan',
              description: 'Snap a photo of Costco Wholesale paper receipt',
              url: '/?action=scan',
            ...
            },
            {
              name: 'Search Items',
              short_name: 'Search',
              description: 'Quickly search all items and prices',
              url: '/?action=search',
              icons: [{ src: '/icons/icon-light-192.png', sizes: '192x192' }],
            },
          ],
